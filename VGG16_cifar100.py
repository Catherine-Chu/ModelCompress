...
class PrunningFineTuner_VGG16:
    ...
    def prune(self):
        ...
        for it_k in range(iterations):
            ...
            torch.save(model,"./pruned/vgg16_cifar100_prunned_%d" % it_k)
        ...
        torch.save(model, "vgg16_cifar100_prunned")
...
if __name__ == '__main__':
    ...
    with open('./vgg_100_out.txt', 'w+', 1) as redirect_out:
        ...
        if use_gpu:
            if args.train:
                ...
                if args.restore:
                    model.load_state_dict(torch.load("vgg16_model_100").state_dict())
            elif args.prune:
            ...
            if args.train:
                ...
                model = torch.load("vgg16_model_100")
        ...
        if args.train:
            ...
            torch.save(model, "vgg16_model_100")
